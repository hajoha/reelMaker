...
def get_timestamps(file):
    ...
    tempo, beats = lr.beat.beat_track(y=y, sr=sr, hop_length=512, onset_envelope=onset_env)
    print(f'bpm:{tempo}')
...
if __name__ == '__main__':
    cut_len = cut_file("00:01:20:00", "00:01:37:05", "foo.wav")
    ...
    for timestamp in timestamps:
        ...
        grad = color_gradient(SIZE, p1=(40, 480), p2=(480, 40),
    ...
    final_video.write_videofile("TEXT.mp4", fps=60)
